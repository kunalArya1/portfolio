    ...
    return response.results
      ...
      .map((page) => {
        try {
          ...
          console.log('Processing page properties:', properties);
          
          // Try both "Featured" and "featured" property names
          const featuredValue = getPropertyValue(properties, 'Featured') || getPropertyValue(properties, 'featured');
          console.log('Featured value:', featuredValue);
